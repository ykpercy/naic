...
def Encoder(x,feedback_bits):
    ...
    with tf.compat.v1.variable_scope('Encoder'):
        ...
        # # delte dropout
        # block4a_expand_conv = layers.Conv2D(240, 1, padding = 'SAME',activation="relu")(residual_3b)
        ...
        top_conv = layers.Conv2D(128, 3, padding = 'SAME',activation="relu")(block3b_bn)
...
def Decoder(x,feedback_bits):
    ...
    # block3b_project_conv = layers.Conv2D(40, 3, padding = 'SAME',activation="relu")(block5c_project_bn)
    # block3b_project_bn = layers.BatchNormalization()(block3b_project_conv)
    # # delte dropout
    ...
    block3a_project_conv = layers.Conv2D(40, 3, padding = 'SAME',activation="relu")(top_bn)
    block3a_project_bn = layers.BatchNormalization()(block3a_project_conv)
