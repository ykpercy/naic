...
def Encoder(x,feedback_bits):
    ...
    with tf.compat.v1.variable_scope('Encoder'):
        stem_conv = layers.Conv2D(32, 3, padding = 'SAME', activation="relu")(x)
        ...
        block1a_project_conv = layers.Conv2D(16, 3, padding = 'SAME',activation="relu")(block1a_bn)
        ...
        block2a_project_conv = layers.Conv2D(24, 3, padding = 'SAME',activation="relu")(block2a_bn)
        ...
        block2b_project_conv = layers.Conv2D(24, 3, padding = 'SAME',activation="relu")(block2b_bn)
        block2b_project_bn = layers.BatchNormalization()(block2b_project_conv)

        residual_2b = layers.Add()([block2a_project_bn, block2b_project_bn])
        # delte dropout
        block3a_expand_conv = layers.Conv2D(144, 1, padding = 'SAME',activation="relu")(residual_2b)
        ...
        block3a_project_conv = layers.Conv2D(40, 3, padding = 'SAME',activation="relu")(block3a_bn)
        ...
        block3b_project_conv = layers.Conv2D(40, 3, padding = 'SAME',activation="relu")(block3b_bn)
        block3b_project_bn = layers.BatchNormalization()(block3b_project_conv)

        residual_3b = layers.Add()([block3a_project_bn, block3b_project_bn])
        # delte dropout
        block4a_expand_conv = layers.Conv2D(240, 3, padding = 'SAME',activation="relu")(residual_3b)
        ...
        block5c_project_conv = layers.Conv2D(112, 3, padding = 'SAME',activation="relu")(block4b_bn)
        block5c_project_bn = layers.BatchNormalization()(block5c_project_conv)

        top_conv = layers.Conv2D(128, 1, padding = 'SAME',activation="relu")(block5c_project_bn)
...
def Decoder(x,feedback_bits):
    ...
    x_ini = layers.Reshape((16, 32, 2))(x)
    # feature map is (8, 16,)
    top_conv = layers.Conv2D(128, 3, padding = 'SAME', activation="relu")(x_ini)
    top_bn = layers.BatchNormalization()(top_conv)
    ...
    # block4c_project_conv = layers.Conv2D(80, 3, padding = 'SAME',activation="relu")(block5c_project_bn)
    # block4c_project_bn = layers.BatchNormalization()(block4c_project_conv)
    # # delte dropout
    # block5a_expand_conv = layers.Conv2D(480, 1, padding = 'SAME',activation="relu")(block4c_project_bn)
    # block5a_expand_bn = layers.BatchNormalization()(block5a_expand_conv)
    ...
    block4a_project_conv = layers.Conv2D(80, 3, padding = 'SAME',activation="relu")(block5c_project_bn)
    block4a_project_bn = layers.BatchNormalization()(block4a_project_conv)
    block4b_expand_conv = layers.Conv2D(480, 1, padding = 'SAME',activation="relu")(block4a_project_bn)
    block4b_expand_bn = layers.BatchNormalization()(block4b_expand_conv)
    block4b_dwconv = layers.DepthwiseConv2D(1, padding = 'SAME', activation="relu")(block4b_expand_bn)
    ...
    block3b_project_conv = layers.Conv2D(40, 3, padding = 'SAME',activation="relu")(block4b_bn)
    block3b_project_bn = layers.BatchNormalization()(block3b_project_conv)
    # delte dropout
    ...
    block3b_expand_conv = layers.Conv2D(240, 1, padding = 'SAME',activation="relu")(residual_3b)
    block3b_expand_bn = layers.BatchNormalization()(block3b_expand_conv)
    block3b_dwconv = layers.DepthwiseConv2D(1, padding = 'SAME', activation="relu")(block3b_expand_bn)
    block3b_bn = layers.BatchNormalization()(block3b_dwconv)
    # block3b_se_squeeze = layers.GlobalAveragePooling2D()(block3b_bn)
    ...
    block2b_project_conv = layers.Conv2D(24, 3, padding = 'SAME',activation="relu")(block3b_bn)
    block2b_project_bn = layers.BatchNormalization()(block2b_project_conv)
    # delte dropout
    ...
    block2a_project_conv = layers.Conv2D(24, 3, padding = 'SAME',activation="relu")(block3a_bn)
    block2a_project_bn = layers.BatchNormalization()(block2a_project_conv)

    residual_2b = layers.Add()([block2a_project_bn, block2b_project_bn])
    # feature map is (4, 8,)
    # block2b_project_up = layers.UpSampling2D((2,2))(block2a_project_bn)
    block2b_expand_conv = layers.Conv2D(144, 1, padding = 'SAME',activation="relu")(residual_2b)
    block2b_expand_bn = layers.BatchNormalization()(block2b_expand_conv)
    block2b_dwconv = layers.DepthwiseConv2D(1, padding = 'SAME', activation="relu")(block2b_expand_bn)
    block2b_bn = layers.BatchNormalization()(block2b_dwconv)
    # block2b_se_squeeze = layers.GlobalAveragePooling2D()(block2b_bn)
    ...
    block1a_project_conv = layers.Conv2D(16, 3, padding = 'SAME',activation="relu")(block2b_bn)
    block1a_project_bn = layers.BatchNormalization()(block1a_project_conv)
    # feature map is (8, 16,)
    ...
    stem_conv = layers.Conv2D(32, 3, padding = 'SAME', activation="relu")(block2a_bn)
    stem_bn = layers.BatchNormalization()(stem_conv)
    ...
    decoder_output = layers.Conv2D(2, 3, padding = 'SAME',activation="sigmoid")(blockla_bn)
