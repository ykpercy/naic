...
# Data loading
data_load_address = '/content/drive/My Drive/NAIC/data'
...
modelsave1 = '/content/drive/My Drive/NAIC/Modelsave/encoder.h5'
encoder.save(modelsave1)
# save decoder
# modelsave2 = './Modelsave/decoder.h5'
modelsave2 = '/content/drive/My Drive/NAIC/Modelsave/decoder.h5'
